...
✅ **Generates** worksheets using Playwright
✅ **Assesses** quality with 7-dimension scoring + vision analysis
✅ **Detects** issues automatically (broken images, wrong numbers, mismatched objects)
✅ **Self-heals** by applying fixes and re-testing
✅ **Validates** production readiness (≥90% pass rate, 0 P0 failures)
...
**What happens**:
- 3 cycles × 5 iterations = 15 worksheets generated
...
- `reception-number-counting-counting-to-10` ← START HERE
...
1. Football→Sailor image mismatches - Adjusts catalog priorities
...
✅ **Pass Rate** ≥90% (9 out of 10 worksheets pass)
✅ **P0 Failures** = 0 (no broken images, no generation errors)
✅ **Avg Score** ≥85/100 (Reception) or ≥80/100 (Year 1-6)
✅ **All Quality Gates** pass config-specific thresholds
...
├── FINAL-REPORT.json        # Machine-readable summary
├── FINAL-REPORT.md           # Human-readable summary
├── cycle-1/, cycle-2/, cycle-3/  # Individual cycle results with screenshots
└── self-healing-plan-*.json  # Vision-based fix recommendations
```
