...
const WORKSHEET_SLUG = 'fractions-recognising-fractions-v6'
// 9 answers: Q1(1) + Q2(1) + Q3(2) + Q4(4) + Q5(1)
// Q1: 3/4, Q2: B, Q3: a)4 b)2, Q4: a)2/4 b)1/4 c)3/4 d)1/2, Q5: 2/4
const WORKSHEET_ANSWERS = ["3/4", "B", "4", "2", "2/4", "1/4", "3/4", "1/2", "2/4"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG} (Fractions)`, () => {
