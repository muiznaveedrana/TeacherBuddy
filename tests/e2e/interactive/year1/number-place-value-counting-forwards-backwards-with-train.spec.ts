...
const WORKSHEET_SLUG = 'number-place-value-counting-forwards-backwards-with-train'
const WORKSHEET_ANSWERS = ["7","10","13","13","11","13","15","17"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-counting-forwards-backwards-with-train.png`, fullPage: true })
