...
const WORKSHEET_SLUG = 'addition-subtraction-adding-to-20'
const WORKSHEET_ANSWERS = ["12", "14", "13", "7", "13"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/addition-subtraction-adding-to-20.png`, fullPage: true })
