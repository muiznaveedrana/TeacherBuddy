...
const WORKSHEET_SLUG = '2d-shapes-name-and-count-shapes-fill-in-the-blank'
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/2d-shapes-name-and-count-shapes-fill-in-the-blank.png`, fullPage: true })
