...
const WORKSHEET_SLUG = 'time-days-and-months-foundation-vfoundation-251216-174443'
// This version has duplicate Q2 inputs: "Sunday, Sunday"
const WORKSHEET_ANSWERS = ["Wednesday", "Sunday", "Sunday", "April", "Winter", "Tomorrow"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/time-days-and-months-foundation-vfoundation-251216-174443.png`, fullPage: true })
