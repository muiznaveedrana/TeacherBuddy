...
const WORKSHEET_SLUG = 'time-days-and-months-challenge-vchallenge-251216-174504'
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/time-days-and-months-challenge-vchallenge-251216-174504.png`, fullPage: true })
