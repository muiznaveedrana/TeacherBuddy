...
/**
 * Interactive Worksheet Test: Measurement - Coins Recognition
 * Year Group: Year 1
 * Topic: measurement
 * Subtopic: coins-recognition
 *
 * Auto-generated test that verifies 100% score
 */

const WORKSHEET_SLUG = 'measurement-coins-recognition'
const WORKSHEET_ANSWERS = ["10","6","18","8","Bear"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/measurement-coins-recognition.png`, fullPage: true })
