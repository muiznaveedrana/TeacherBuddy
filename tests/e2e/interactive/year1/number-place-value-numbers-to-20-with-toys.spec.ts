...
const WORKSHEET_SLUG = 'number-place-value-numbers-to-20-with-toys'
const WORKSHEET_ANSWERS = ["15","9","17","14","16","C","B","D","A"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-numbers-to-20-with-toys.png`, fullPage: true })
