...
/**
 * Interactive Worksheet Test: Number Place Value - Numbers To 20
 * Year Group: Year 1
...
const WORKSHEET_SLUG = 'number-place-value-numbers-to-20-with-shapes'
const WORKSHEET_ANSWERS = ["9","5","20","17","19","C","A","D","B"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-numbers-to-20-with-shapes.png`, fullPage: true })
