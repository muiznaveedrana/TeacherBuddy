...
const WORKSHEET_SLUG = 'addition-subtraction-adding-to-20-v3'
const WORKSHEET_ANSWERS = ["12", "16", "13", "9", "14"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/addition-subtraction-adding-to-20-v3.png`, fullPage: true })
