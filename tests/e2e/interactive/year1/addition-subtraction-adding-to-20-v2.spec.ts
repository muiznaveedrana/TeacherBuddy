...
/**
 * Interactive Worksheet Test: Addition Subtraction - Adding To 20
 * Year Group: Year 1
 * Topic: addition-subtraction
 * Subtopic: adding-to-20
 *
 * Auto-generated test that verifies 100% score
 */

const WORKSHEET_SLUG = 'addition-subtraction-adding-to-20-v2'
const WORKSHEET_ANSWERS = ["12", "13", "14", "9", "15"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/addition-subtraction-adding-to-20-v2.png`, fullPage: true })
