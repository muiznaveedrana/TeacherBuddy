...
/**
 * Interactive Worksheet Test: Addition Subtraction - Subtracting Within 20
 * Year Group: Year 1
...
const WORKSHEET_SLUG = 'addition-subtraction-subtracting-within-20-v2'
// Q1: 7, Q2: 8, Q3: 4, Q4 (fact family): 13, 8, 5, Q5: 7
const WORKSHEET_ANSWERS = ["7", "8", "4", "13", "8", "5", "7"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/addition-subtraction-subtracting-within-20-v2.png`, fullPage: true })
