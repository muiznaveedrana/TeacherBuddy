...
const WORKSHEET_SLUG = 'number-place-value-number-bonds-10-v2'
// 11 inputs for this worksheet - each input is a number bond component
const WORKSHEET_ANSWERS = ["7", "1", "5", "9", "2", "8", "3", "4", "8", "1", "6"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-number-bonds-10-v2.png`, fullPage: true })
