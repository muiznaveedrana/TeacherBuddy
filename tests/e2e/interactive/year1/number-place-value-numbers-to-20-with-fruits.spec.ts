...
/**
 * Interactive Worksheet Test: number-place-value-numbers-to-20-with-fruits
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-place-value-numbers-to-20-with-fruits'
const WORKSHEET_ANSWERS = ["12","16","14","10","12","D","C","A","B"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-numbers-to-20-with-fruits.png`, fullPage: true })
