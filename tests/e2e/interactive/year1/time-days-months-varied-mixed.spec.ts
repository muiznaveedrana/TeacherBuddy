...
/**
 * Interactive Worksheet Test: Time Days and Months - Varied (Mixed Layout)
 * Year Group: Year 1
 */

const WORKSHEET_SLUG = 'time-days-and-months-varied-vvaried'
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/time-days-and-months-varied-vvaried.png`, fullPage: true })
