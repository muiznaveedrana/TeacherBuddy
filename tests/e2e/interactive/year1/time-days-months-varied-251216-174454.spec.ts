...
const WORKSHEET_SLUG = 'time-days-and-months-varied-vvaried-251216-174454'
// This version has duplicate Q2 inputs: "Tuesday, Tuesday"
const WORKSHEET_ANSWERS = ["Saturday", "Tuesday", "Tuesday", "October", "Summer", "Tomorrow"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/time-days-and-months-varied-vvaried-251216-174454.png`, fullPage: true })
