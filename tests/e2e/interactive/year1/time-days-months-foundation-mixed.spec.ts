...
/**
 * Interactive Worksheet Test: Time Days and Months - Foundation (Mixed Layout)
 * Year Group: Year 1
 * Auto-generated test that verifies 100% score
 */

const WORKSHEET_SLUG = 'time-days-and-months-foundation-vfoundation'
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/time-days-and-months-foundation-vfoundation.png`, fullPage: true })
