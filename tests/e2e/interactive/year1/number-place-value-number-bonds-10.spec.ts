...
const WORKSHEET_SLUG = 'number-place-value-number-bonds-10'
// 11 inputs for this worksheet - each input is a number bond component
const WORKSHEET_ANSWERS = ["4", "2", "4", "6", "3", "7", "6", "7", "2", "5", "9"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-number-bonds-10.png`, fullPage: true })
