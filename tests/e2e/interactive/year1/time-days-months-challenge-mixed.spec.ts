...
/**
 * Interactive Worksheet Test: Time Days and Months - Challenge (Mixed Layout)
 * Year Group: Year 1
 */
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/time-days-and-months-challenge-vchallenge.png`, fullPage: true })
