...
const WORKSHEET_SLUG = 'number-place-value-numbers-to-100'
// 8 inputs for this worksheet
const WORKSHEET_ANSWERS = ["35", "4", "2", "38", "7", "30", "1", "35"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-numbers-to-100.png`, fullPage: true })
