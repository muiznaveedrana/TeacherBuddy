...
/**
 * Interactive Worksheet Test: Two-Digit Addition and Subtraction - School Theme
 * Year Group: Year 2
...
const WORKSHEET_ANSWERS = ["30","8","38","55","26","22","46","No","46"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  ...
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/two-digit-addition-and-subtraction-school.png`, fullPage: true })
