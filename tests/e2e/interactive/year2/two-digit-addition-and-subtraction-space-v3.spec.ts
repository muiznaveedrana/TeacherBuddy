...
/**
 * Interactive Worksheet Test: Two-Digit Addition and Subtraction - Space Theme
 * Year Group: Year 2
...
const WORKSHEET_ANSWERS = ["80","14","94","95","46","36","54","No","54"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  // FIXME: Database answer key issue - Q5 multi-part (Yes/No + calculation) incomplete
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/two-digit-addition-and-subtraction-space-v3.png`, fullPage: true })
