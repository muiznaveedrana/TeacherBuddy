...
const WORKSHEET_SLUG = 'mental-maths-strategies-challenge-challenge-mental-math'
// Q1: 13, 17, 31 (near doubles)
// Q2: 64, 63, 78, 41, 72, 56
// Q3: 15, 15, 8, 7 (fact family)
// Q4: 68, 68, 53
// Q5: Sometimes, 5
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/mental-maths-strategies-challenge-challenge-mental-math.png`, fullPage: true })
