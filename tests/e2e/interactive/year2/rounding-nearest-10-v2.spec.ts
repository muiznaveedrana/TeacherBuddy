...
/**
 * Interactive Worksheet Test: Rounding to Nearest 10 - Animals
 * Year Group: Year 2
...
const WORKSHEET_SLUG = 'number-place-value-rounding-nearest-10-v2'
// Q1: 56 between 50 and 60, rounds to 60 (6>5)
// Q2: 63 closer to 60, rounds to 60 (3<5)
// Q3: 48→50, 52→50, 65→70, 71→70, 59→60, 44→40
// Q4: 68 bananas → 70
// Q5: 65 rounds to 60? No, rounds to 70 (5 rounds up)
const WORKSHEET_ANSWERS = ["20","30","20","30","30","10","30","30","20","30","30","40","Yes","30"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-rounding-nearest-10-v2.png`, fullPage: true })
