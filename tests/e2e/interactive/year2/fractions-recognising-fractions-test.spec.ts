...
// Q1: 1/3 (fraction shaded), Q2: C (which shows fraction), Q3: a)4 b)2 parts, Q4: 4 fractions, Q5: word problem
const WORKSHEET_ANSWERS = ["1/3","C","4","2","1/4","1/2","1/3","1/4","2"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/fractions-recognising-fractions-test.png`, fullPage: true })
