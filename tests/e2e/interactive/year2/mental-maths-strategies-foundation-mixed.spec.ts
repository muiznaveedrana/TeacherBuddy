...
const WORKSHEET_SLUG = 'mental-maths-strategies-foundation-foundation'
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/mental-maths-strategies-foundation-foundation.png`, fullPage: true })
