...
const WORKSHEET_SLUG = 'number-place-value-comparing-numbers-v2'
// Simplified answers - 15 text inputs + No button click
const WORKSHEET_ANSWERS = ["58", "tens", "53", "60", "99", ">", "=", "<", "39", "48", "55", "61", "Class A", ">", "5"]
const YES_NO_BUTTON = "No" // Which button to click for Q3
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-comparing-numbers-v2.png`, fullPage: true })
