...
// Q1-Q3: 1 input each, Q4: 4 inputs, Q5: 3 inputs = 10 total
// Q4: 30-8=[22], [22]-5=[17], Lucy has [17] erasers
// Q5: 32-15=[17], 32+7=[39], Now there are [39] children
const ANSWERS = ['20', '12', '9', '22', '22', '17', '17', '17', '39', '39']
...
test.describe('Interactive Worksheet: Word Problems Y2 V1', () => {
  test('should complete worksheet and achieve 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/addition-subtraction-word-problems.png`, fullPage: true })
