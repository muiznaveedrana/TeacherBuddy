...
const WORKSHEET_SLUG = 'times-tables-2-5-10-quick-recall-mixed-fill-in-the-blan'
// Q1: 6, 15, 30, 8, 20, 40, 12, 30, 60
// Q2: 10, 35, 80, 18, 30, 40
// Q3: 2, 5, 10, 4, 2, 8
// Q4: 50, 12
// Q5: True, True, True
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/times-tables-2-5-10-quick-recall-mixed-fill-in-the-blan.png`, fullPage: true })
