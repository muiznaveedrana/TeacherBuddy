...
/**
 * Interactive Worksheet Test: Number Place Value - Numbers To 100
 * Year Group: Year 2
...
const WORKSHEET_SLUG = 'number-place-value-numbers-to-100-v2'
// 8 inputs for this worksheet
const WORKSHEET_ANSWERS = ["63", "5", "8", "62", "5", "50", "4", "67"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-numbers-to-100-v2.png`, fullPage: true })
