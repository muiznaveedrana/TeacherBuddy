...
/**
 * Interactive Worksheet Test: Equal Groups: Animal Fun!
 * Year Group: Year 2
...
const WORKSHEET_SLUG = 'equal-groups-animal-fun-with-animals-counting-standard-layout'
// Q1: 15 (total chickens)
// Q2: 4, 3, 12 (groups, per group, total)
// Q3: 20, 15, 35 (calculations)
// Q4: 30 (sheep problem)
// Q5: Yes, 18, 18 (all parts validated)
const WORKSHEET_ANSWERS = ["15","4","3","12","20","15","35","30","Yes","18","18"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/equal-groups-animal-fun-with-animals-counting-standard-layout.png`, fullPage: true })
