...
const WORKSHEET_ANSWERS = ["10","25","25","8","30","50","14","20","60","60","No","25"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/multiplication-division-times-tables-2-5-10-v3.png`, fullPage: true })
