...
const WORKSHEET_SLUG = 'fractions-recognising-fractions'
// Q1: 1/2 (fraction shaded), Q2: A (which shows 1/2), Q3: a)2 b)1 parts, Q4: 4 fractions, Q5: word problem
const WORKSHEET_ANSWERS = ["1/2","A","2","1","1/2","1/2","1/4","1/4","1"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/fractions-recognising-fractions.png`, fullPage: true })
