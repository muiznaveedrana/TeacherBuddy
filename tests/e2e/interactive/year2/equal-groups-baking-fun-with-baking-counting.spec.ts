...
/**
 * Interactive Worksheet Test: Equal Groups: Baking Fun!
 * Year Group: Year 2
...
const WORKSHEET_SLUG = 'equal-groups-baking-fun-with-baking-counting-standard-layout'
const WORKSHEET_ANSWERS = ["12","5","2","10","15","12","40","24","Yes","15","15"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  ...
  // Q5 database answer key is incomplete - only has first sub-answer
  // Same issue as equal-groups-v1.spec.ts - database data problem
