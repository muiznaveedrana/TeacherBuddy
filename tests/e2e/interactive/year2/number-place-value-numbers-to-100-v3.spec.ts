...
const WORKSHEET_SLUG = 'number-place-value-numbers-to-100-v3'
// 8 inputs for this worksheet
const WORKSHEET_ANSWERS = ["84", "9", "1", "86", "2", "90", "5", "78"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-numbers-to-100-v3.png`, fullPage: true })
