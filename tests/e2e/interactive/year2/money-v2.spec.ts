...
/**
 * Interactive Worksheet Test: Measurement - Money
 * Year Group: Year 2
 * Topic: measurement
 * Subtopic: money
 *
...
const WORKSHEET_SLUG = 'measurement-money-v2'
const WORKSHEET_ANSWERS = ["82","63","Mia","55","77"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/measurement-money-v2.png`, fullPage: true })
