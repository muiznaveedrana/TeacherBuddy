...
const WORKSHEET_SLUG = 'mental-maths-strategies-practice-practice-mental-maths'
// Q1: 6, 7, 7 (missing numbers)
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/mental-maths-strategies-practice-practice-mental-maths.png`, fullPage: true })
