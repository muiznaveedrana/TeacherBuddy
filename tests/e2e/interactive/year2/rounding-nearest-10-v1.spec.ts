...
const WORKSHEET_ANSWERS = ["30","40","30","40","40","20","40","40","30","40","40","50","No","40"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-place-value-rounding-nearest-10.png`, fullPage: true })
