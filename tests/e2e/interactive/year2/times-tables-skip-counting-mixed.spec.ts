...
const WORKSHEET_SLUG = 'times-tables-2-5-10-skip-counting-mixed-patterns'
// Q1: 6, 8, 10, 12, 15, 20, 25, 30, 30, 40, 50, 60
// Q2: 5, 2, 7, 5
// Q3: 3, 5, 15, 5, 2, 10
// Q4: 20, 10
// Q5: C, 25
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/times-tables-2-5-10-skip-counting-mixed-patterns.png`, fullPage: true })
