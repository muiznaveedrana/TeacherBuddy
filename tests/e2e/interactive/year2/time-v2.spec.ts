...
const WORKSHEET_ANSWERS = ["10:30","9","00","2","00","6","30","12:00","3","2","1","5:45","No"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
    // Question 5a asks: PE starts at 1:30, lasts 45 minutes. Answer should be 2:15 but worksheet expects different value.
  // Question 5b asks: Is Tom correct that long hand on 6 means 6 o'clock? Answer should be "No" but worksheet may expect different format.
