...
/**
 * Interactive Worksheet Test: Measurement - Time Test
 * Year Group: Year 2
 * Topic: measurement
 * Subtopic: time-test
 *
...
const WORKSHEET_SLUG = 'measurement-time-test'
const WORKSHEET_ANSWERS = ["7:30","8","00","11","00","4","30","10:30","3","2","1","3:15","No"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
    // This worksheet appears to be identical to measurement-time-v2
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/measurement-time-test.png`, fullPage: true })
