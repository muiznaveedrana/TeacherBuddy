...
const WORKSHEET_SLUG = 'mental-maths-foundation'
// Q1: 10, 14, 18
// Q2: 27, 56, 48, 82, 19, 74
// Q3: 12, 8, 12, 8, 20
// Q4: 39, 39
// Q5: True, False, True
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/mental-maths-foundation.png`, fullPage: true })
