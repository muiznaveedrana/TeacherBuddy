...
/**
 * Interactive Worksheet Test: Two-Digit Addition and Subtraction - Animal Theme
 * Year Group: Year 2
...
const WORKSHEET_ANSWERS = ["50","13","63","83","35","34","27","No","27"];
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  // FIXME: Times out on scrollIntoViewIfNeeded - likely needs cookie consent fix
  // Also likely has Q5 database answer key issue (Yes/No + calculation)
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/two-digit-addition-and-subtraction-animals-v2.png`, fullPage: true })
