...
const WORKSHEET_SLUG = 'recognising-fractions-mixed-layout-test'
// Q1: 1/2, 1/4, 1/3
// Q2: 2/4, 2/3, 3/4, 2/2, 4/4, 3/3
// Q3: 4, 3
// Q4: 1/4, 2
// Q5: Yes, 2
const WORKSHEET_ANSWERS = [
  "1/2", "1/4", "1/3",
  "2/4", "2/3", "3/4", "2/2", "4/4", "3/3",
  "4", "3",
  "1/4", "2",
  "Yes", "2"
]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/recognising-fractions-mixed-layout-test.png`, fullPage: true })
