...
const WORKSHEET_SLUG = 'times-tables-to-12-foundation-food-theme-food'
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/times-tables-to-12-foundation-food-theme-food.png`, fullPage: true })
