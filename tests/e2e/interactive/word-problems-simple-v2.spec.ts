...
test.describe('Interactive Worksheet: word-problems-simple v2', () => {
  test('should complete worksheet with 100% score (via HTML file)', async ({ page }) => {
    ...
    const htmlPath = join(process.cwd(), 'public', 'preview-worksheet-word-problems-simple-2.html');
    ...
    console.log('✓ Worksheet v2 loaded successfully with 5 questions');
  ...
  test.skip('should complete worksheet with 100% score (requires /worksheets route)', async ({ page }) => {
    ...
    await page.goto('http://localhost:3000/worksheets/addition-subtraction-word-problems-simple-v2');
