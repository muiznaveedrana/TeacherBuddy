...
const WORKSHEET_SLUG = 'number-counting-early-subtraction-v4'
const WORKSHEET_ANSWERS = ["4", "5", "6", "4", "B"]
...
test.describe(`Interactive: Early Subtraction Mixed Layout`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-early-subtraction-v4.png`, fullPage: true })
