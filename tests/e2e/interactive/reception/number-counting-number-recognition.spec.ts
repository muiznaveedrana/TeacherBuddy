...
/**
 * Interactive Worksheet Test: number-counting-number-recognition
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-number-recognition'
const WORKSHEET_ANSWERS = ["6","3","8","seven","two","5"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-number-recognition.png`, fullPage: true })
