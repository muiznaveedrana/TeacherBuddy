...
const WORKSHEET_SLUG = 'shape-space-basic-shapes-v2'
const WORKSHEET_ANSWERS = ['B', '5', '7', 'C', 'B']
...
test.describe('Interactive Worksheet: Basic Shapes V2', () => {
  test('should complete worksheet and achieve 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/shape-space-basic-shapes-v2.png`, fullPage: true })
