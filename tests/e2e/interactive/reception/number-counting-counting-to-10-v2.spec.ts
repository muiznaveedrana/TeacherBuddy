...
/**
 * Interactive Worksheet Test: number-counting-counting-to-10-v2
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-counting-to-10-v2'
const WORKSHEET_ANSWERS = ["7","3","10","5","8"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-counting-to-10-v2.png`, fullPage: true })
