...
/**
 * Interactive Worksheet Test: number-counting-early-subtraction
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-early-subtraction'
const WORKSHEET_ANSWERS = ["4","5","5","4","3"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-early-subtraction.png`, fullPage: true })
