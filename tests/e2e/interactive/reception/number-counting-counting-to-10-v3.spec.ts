...
/**
 * Interactive Worksheet Test: number-counting-counting-to-10-v3
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-counting-to-10-v3'
const WORKSHEET_ANSWERS = ["4","9","6","1","7"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-counting-to-10-v3.png`, fullPage: true })
