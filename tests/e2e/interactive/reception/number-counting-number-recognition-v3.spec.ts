...
/**
 * Interactive Worksheet Test: number-counting-number-recognition-v3
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-number-recognition-v3'
const WORKSHEET_ANSWERS = ["2","4","10","one","six","9"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-number-recognition-v3.png`, fullPage: true })
