...
/**
 * Interactive Worksheet Test: Size Comparison - School & Treats
...
const WORKSHEET_SLUG = 'size-comparison-school-treats-school-treats-comparison'
const WORKSHEET_ANSWERS = ["Right","Right","Left","Noah","B"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/size-comparison-school-treats-school-treats-comparison.png`, fullPage: true })
