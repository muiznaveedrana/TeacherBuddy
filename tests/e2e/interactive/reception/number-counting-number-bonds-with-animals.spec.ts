...
/**
 * Interactive Worksheet Test: number-counting-number-bonds-with-animals
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-number-bonds-with-animals'
const WORKSHEET_ANSWERS = ["2","3","3","4","3"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-number-bonds-with-animals.png`, fullPage: true })
