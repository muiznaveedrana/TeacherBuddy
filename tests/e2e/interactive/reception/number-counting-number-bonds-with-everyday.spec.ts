...
/**
 * Interactive Worksheet Test: number-counting-number-bonds-with-everyday
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-number-bonds-with-everyday'
const WORKSHEET_ANSWERS = ["3","4","2","10","4"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-number-bonds-with-everyday.png`, fullPage: true })
