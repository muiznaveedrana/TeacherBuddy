...
const WORKSHEET_SLUG = 'number-counting-number-recognition-v4'
const WORKSHEET_ANSWERS = ["7", "5", "8", "six", "nine", "B", "6"]
...
test.describe(`Interactive: Number Recognition Mixed Layout`, () => {
