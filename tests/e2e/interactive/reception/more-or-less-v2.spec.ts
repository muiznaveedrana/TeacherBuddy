...
/**
 * Interactive Worksheet Test: More or Less V2 (School Supplies)
 * Year Group: Reception
 * Topic: number-counting
 * Subtopic: more-or-less
 */

const WORKSHEET_SLUG = 'number-counting-more-or-less-v2'
// Answers: B, A, Ava, A, Ben
const WORKSHEET_ANSWERS = ['B', 'A', 'Ava', 'A', 'Ben']
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-more-or-less-v2.png`, fullPage: true })
