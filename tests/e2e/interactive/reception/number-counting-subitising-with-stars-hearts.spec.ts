...
/**
 * Interactive Worksheet Test: number-counting-subitising-with-stars-hearts
...
const WORKSHEET_SLUG = 'number-counting-subitising-with-stars-hearts'
const WORKSHEET_ANSWERS = ["4", "3", "4", "5", "4"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-subitising-with-stars-hearts.png`, fullPage: true })
