...
/**
 * Interactive Worksheet Test: number-counting-counting-to-10
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-counting-to-10'
const WORKSHEET_ANSWERS = ["6","9","2","8","4"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-counting-to-10.png`, fullPage: true })
