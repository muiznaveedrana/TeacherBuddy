...
/**
 * Interactive Worksheet Test: number-counting-number-bonds-with-nature
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-number-bonds-with-nature'
const WORKSHEET_ANSWERS = ["4","2","1","8","2"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-number-bonds-with-nature.png`, fullPage: true })
