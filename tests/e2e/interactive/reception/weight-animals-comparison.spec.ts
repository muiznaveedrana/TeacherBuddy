...
/**
 * Interactive Worksheet Test: Weight Comparison - Animals
...
const WORKSHEET_SLUG = 'weight-comparison-animals-comparison'
const WORKSHEET_ANSWERS = ["A","B","A","B","A"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/weight-comparison-animals-comparison.png`, fullPage: true })
