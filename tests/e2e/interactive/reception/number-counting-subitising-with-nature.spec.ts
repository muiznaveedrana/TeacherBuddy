...
/**
 * Interactive Worksheet Test: number-counting-subitising-with-nature
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-subitising-with-nature.png`, fullPage: true })
