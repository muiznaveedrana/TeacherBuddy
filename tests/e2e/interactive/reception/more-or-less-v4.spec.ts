...
/**
 * Interactive Worksheet Test: Number Counting - More Or Less
...
const WORKSHEET_SLUG = 'number-counting-more-or-less-v4'
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-more-or-less-v4.png`, fullPage: true })
