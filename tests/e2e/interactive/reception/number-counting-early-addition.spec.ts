...
/**
 * Interactive Worksheet Test: number-counting-early-addition
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-early-addition'
const WORKSHEET_ANSWERS = ["5","7","7","7","6"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-early-addition.png`, fullPage: true })
