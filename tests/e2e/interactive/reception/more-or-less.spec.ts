...
const WORKSHEET_SLUG = 'number-counting-more-or-less'
const WORKSHEET_ANSWERS = ["B","A","Emma","A","Oliver"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-more-or-less.png`, fullPage: true })
