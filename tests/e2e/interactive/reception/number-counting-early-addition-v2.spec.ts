...
/**
 * Interactive Worksheet Test: number-counting-early-addition-v2
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-early-addition-v2'
const WORKSHEET_ANSWERS = ["6","8","5","8","6"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-early-addition-v2.png`, fullPage: true })
