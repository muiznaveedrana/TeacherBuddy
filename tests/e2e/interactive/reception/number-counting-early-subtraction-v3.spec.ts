...
/**
 * Interactive Worksheet Test: number-counting-early-subtraction-v3
 * Auto-generated - fixed version
 */

const WORKSHEET_SLUG = 'number-counting-early-subtraction-v3'
const WORKSHEET_ANSWERS = ["3","4","4","5","4"]
...
test.describe(`Interactive: ${WORKSHEET_SLUG}`, () => {
  test('should complete with 100% score', async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/quality-screenshots/number-counting-early-subtraction-v3.png`, fullPage: true })
