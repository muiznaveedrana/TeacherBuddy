...
/**
 * Interactive Worksheet Test: Weight Comparison - Farm Animals
...
const WORKSHEET_SLUG = 'weight-comparison-farm-animals-farm-animals-comparison'
const WORKSHEET_ANSWERS = ["A","B","A","C","A"]
