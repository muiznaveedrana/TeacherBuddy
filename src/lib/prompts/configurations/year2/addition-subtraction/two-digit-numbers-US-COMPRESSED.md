...
**money**: Use CSS-styled US coins (no images needed):
  - Penny (1¢): copper, 70px
  - Nickel (5¢): silver, 75px
  - Dime (10¢): silver, 60px (smallest)
  - Quarter (25¢): silver, 85px (largest)
...
.money-visual{margin:10px 0;padding:12px;background:#E8F5E9;border:2px solid #4CAF50;border-radius:8px;text-align:center}
.coin-group{display:flex;justify-content:center;gap:10px;flex-wrap:wrap;margin:10px 0}
...
.money-label{font-size:14pt;font-weight:bold;margin:8px 0;color:#2E7D32}
...
9. For money questions: use CSS coin divs (penny, nickel, dime, quarter) with ¢ symbol
...
<div class="money-visual">
  ...
  <p class="money-label">Total: 60¢</p>
</div>
```
