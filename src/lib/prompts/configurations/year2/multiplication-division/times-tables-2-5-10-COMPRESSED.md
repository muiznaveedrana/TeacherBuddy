...
```css
body{font-family:'Comic Sans MS',sans-serif;font-size:15pt;padding:15px;line-height:1.6}
...
.question-text{font-size:15pt;margin:8px 0;font-weight:600}
...
.pattern-sequences p{margin:12px 0;font-size:15pt}
...
.working{font-size:15pt;margin:10px 0}
